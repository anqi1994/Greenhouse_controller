...
#define CHAR_WIDTH 8
#define SCREEN_OFFSET 35
#define MAX_POS_X 120

class currentScreen {
public:
    explicit currentScreen(const std::shared_ptr<ssd1306os> &ssd)
    : ssd(ssd), color0(1), color1(1), color2(1) {};
...
public:
    ...
    static void gpioTaskWrapper(void* param);
